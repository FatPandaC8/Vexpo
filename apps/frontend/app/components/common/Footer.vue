  ...
  <footer class="text-white py-12 mt-20 bg-slate-800">
    <div class="px-6 max-w-7xl mx-auto">
      ...
      <div class="grid md:grid-cols-4 gap-8 mb-8">
        <!--This means: the break point like md: to only apply the utitlity at a medium screen sizes and above;
      ...
      <!--BOTTOM FOOTER-->
      <div
        class="text-slate-400 pt-8 border-t border-slate-700 text-center text-sm"
      >
