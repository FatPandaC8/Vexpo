...
<template>
  <div class="min-h-screen bg-slate-50">
    ...
    <!-- Hero -->
    <section
      class="bg-linear-to-br from-slate-800 to-slate-900 text-white py-16 px-8"
    >
      <div class="max-w-7xl mx-auto text-center">
        <h1 class="text-4xl font-bold mb-3">Exhibiting Companies</h1>
        <p class="text-slate-400 text-lg mb-8">
          Browse companies showcasing at ExpoVerse events
        </p>
          ...
          <div v-else class="grid grid-cols-3 gap-5">
            ...
            >
              <div class="p-6">
                ...
                <h3
                  class="font-bold text-gray-900 mb-1 line-clamp-1 group-hover:text-[#3d52d5] transition-colors"
                >
                  {{ company.name }}
                </h3>
                ...
                <div class="flex items-center gap-1.5 mb-3">
                  ...
                  <span v-if="company.country" class="text-xs text-gray-400"
                ...
                >
                  <div class="flex items-center gap-1.5 text-xs text-gray-400">
                    ...
                    />
                    <span
                      >{{ boothCount(company) }} booth{{
                        boothCount(company) > 1 ? "s" : ""
                      }}</span
                    >
                  </div>
                  <a
