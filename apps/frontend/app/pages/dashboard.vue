...
const { roleBadgeColor, roleLabel, greeting, welcomeConfig } = useDashboardUI(auth);
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
          ...
          <h1 class="text-sm text-gray-600">
            {{ greeting }},
            <strong class="text-gray-900">{{ auth.user.value?.name?.split(" ")[0] }}</strong>
          </h1>
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <div class="border-t border-gray-100 p-3 shrink-0">
          ...
          <div class="flex gap-1">
            ...
            <button
              ...
              @click="auth.logout(); boothStore.reset(); companyStore.reset(); expoStore.reset(); dashboard.reset()"
            >
      ...
      <main class="flex-1 overflow-y-auto p-8 min-w-0">
        ...
        <DashboardPanelsBoothForm
          v-else-if="dashboard.activeView === 'booth-edit' && dashboard.activeData"
          :booth="dashboard.activeData"
          @updated="dashboard.activeData = $event; boothStore.setBooth($event)"
        />
        <DashboardPanelsBoothForm
          v-else-if="dashboard.activeView === 'register-booth' && dashboard.activeData"
        ...
        />
        <DashboardPanelsCompanyForm
          v-else-if="dashboard.activeView === 'company-edit' && dashboard.activeData"
        ...
        <DashboardPanelsExpoForm
          v-else-if="dashboard.activeView === 'expo-manage' && dashboard.activeData"
          :expo="dashboard.activeData"
          @saved="onExpoUpdated"
        ...
        />
        <DashboardPanelsBoothForm
          v-else-if="dashboard.activeView === 'booth-review' && dashboard.activeData"
          :booth="dashboard.activeData"
        ...
        <DashboardPanelsAdminUserEdit
          v-else-if="dashboard.activeView === 'admin-user-edit' && dashboard.activeData"
        ...
        />
        <DashboardPanelsAdminExpoEdit
          v-else-if="dashboard.activeView === 'admin-expo-edit' && dashboard.activeData"
          :expo="dashboard.activeData"
          @saved="onAdminUpdated"
          @deleted="onAdminDeleted"
        />
        <DashboardPanelsAdminBoothEdit
          v-else-if="dashboard.activeView === 'admin-booth-edit' && dashboard.activeData"
          :booth="dashboard.activeData"
          @updated="onAdminUpdated"
          @deleted="onAdminDeleted"
        />
        <DashboardPanelsAdminCompanyEdit
          v-else-if="dashboard.activeView === 'admin-company-edit' && dashboard.activeData"
          :company="dashboard.activeData"
          @updated="onAdminUpdated"
          @deleted="onAdminDeleted"
        />
