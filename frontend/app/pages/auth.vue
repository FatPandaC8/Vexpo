    ...
    <div class="bg-linear-to-r from-blue-50 to-blue-500">
        <div class="p-50">
            ...
            <div class="flex flex-1 mb-10 items-center">
                ...
                <NuxtLink to="#" class="text-gray-500 ml-2">
                    Back to Home
                </NuxtLink>
            </div>
            <!--Breadcrumb-->
            ...
            <div class="grid grid-cols-2">
                ...
                <!--Auth-->
                <UCard class="w-full max-w-lg border-blue-100 bg-white/90 backdrop-blur-sm shadow-2xl shadow-blue-500/10 p-9 rounded-2xl">
                    <UTabs 
                    v-model="activeTab"
                    :items="items" 
                    variant="pill"
                    :ui="{
                                ...
                                <UForm class="space-y-4" :state="signInState" :schema="signInSchema" @submit="onSignIn">
                                    <UFormField name="email" label="Email">
                                        <UInput 
                                            ...
                                            :ui="{
                                                base: 'border border-blue-100 focus:border-blue-300 px-2 h-10'
                                            }"
                                    ...
                                    <UButton 
                                        type="submit"
                                        block 
                                        class="bg-linear-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 shadow-lg shadow-blue-500/30 text-white cursor-pointer h-8"
                                        size="lg">
                                        Sign In
                                    </UButton>
                                    ...
                                    <div class="flex items-center justify-center">
                                        ...
                                        variant="outline"
                                        block 
                                        class="border-blue-200 bg-blue-50 hover:bg-blue-100 hover:text-blue-500 hover:cursor-pointer h-8"
                        ...
                        <template #signup>
                            <div class="space-y-6">
                                ...
                                <UForm :schema="signUpSchema" :state="signUpState" @submit="" class="space-y-4">
                                    <UFormField name="name" label="Full Name">
                                        <UInput
                                            v-model="signUpState.name"
                                            placeholder="John Doe"
                                            :ui="{
                                                base: 'border border-blue-500 focus:border-blue-300 px-2 h-10'
                                            }"
                                        />
                                    </UFormField>
                                    ...
                                    <UFormField name="role" label="Role">
                                        <USelect
                                            ...
                                            :ui="{
                                                base: 'border border-blue-100 w-full h-10'
                                            }"
                                        />
                                    </UFormField>
