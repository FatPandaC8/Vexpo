      ...
      <div class="grid grid-cols-2 ml-25 mt-20 gap-15">
        ...
        <div class="pr-20">
          <div class="mb-6 gap-3 flex items-center">
            ...
            <div>
              <h1 class="text-3xl font-bold text-blue-600 mb-2 ml-3">
                ExpoVerse
              </h1>
          ...
          <p class="font-bold text-4xl mb-4">
            Welcome to the Future of Virtual Event
          </p>

          <p class="text-lg text-gray-500 mb-8">
            Connect with thousands of exhibitors, explore interactive booths,
        ...
        <!--Auth-->
        <UCard
          class="w-full max-w-xl border-blue-100 bg-white/90 backdrop-blur-sm shadow-2xl shadow-blue-500/10 p-9 rounded-2xl flex flex-col"
        >
          <UTabs
            v-model="activeTab"
            :items="items"
              ...
              <div class="space-y-6">
                ...
                >
                  <UFormField
                    ...
                    :ui="{
                      error:
                        'text-red-500 italic bg-red-500/15 text-center rounded h-6 p-1',
                    }"
                  >
                    <UInput
                  ...
                  <div class="relative my-6">
                    ...
                    <div class="relative flex justify-center text-sm">
                      <span class="px-4 bg-blue-50 text-muted-foreground"
