...
<template>
  ...
  <div class="min-h-screen flex items-center justify-center bg-blue-50">
    <div class="text-center space-y-4">
      <div class="w-12 h-12 mx-auto rounded-full bg-[#3d52d5]/10 flex items-center justify-center">
        <UIcon name="i-lucide-loader-circle" class="w-6 h-6 text-[#3d52d5] animate-spin" />
      </div>
