...
<template>
  <div class="min-h-screen bg-slate-50">
    ...
    <!-- Hero -->
    <section
      class="bg-linear-to-br from-[#3d52d5] to-[#090c9b] text-white py-16 px-8"
    >
      <div class="max-w-7xl mx-auto text-center">
        <h1 class="text-4xl font-bold mb-3">Discover Virtual Expos</h1>
        <p class="text-blue-200 text-lg mb-8">
          Explore live and upcoming exhibitions from around the world
        </p>
            ...
            <div class="space-y-1">
              ...
              >
                <span
                  ...
                  :class="
                    selectedStatus === status ? 'bg-white' : statusDot[status]
                  "
                />
                {{ status }}
              </button>
        ...
        <div class="flex-1">
          <div class="flex items-center justify-between mb-6">
            <p class="text-sm text-gray-500">
              Showing
              <strong class="text-gray-800">{{ filteredExpos.length }}</strong>
              expo{{ filteredExpos.length !== 1 ? "s" : "" }}
            </p>
          </div>
          ...
          <div v-else-if="filteredExpos.length === 0" class="text-center py-20">
            <div
              class="w-16 h-16 mx-auto rounded-2xl bg-gray-100 flex items-center justify-center mb-4"
            >
          ...
          <div v-else class="grid grid-cols-2 gap-5">
            ...
            >
              <div class="p-6">
                ...
                <p
                  class="text-sm text-gray-500 mb-5 line-clamp-2 leading-relaxed"
                >
