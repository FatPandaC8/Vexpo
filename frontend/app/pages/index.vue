      ...
      <div class="grid grid-cols-2 items-center gap-12">
        <div class="p-40">
          ...
          <p class="text-gray-500 mb-8">
            Connect with global exhibitors, explore interactive booths, and
            network with thousands of professionals from the comfort of your
            screen.
          </p>
    ...
    <section class="px-30 pb-24">
      <div class="flex flex-col items-center text-center mb-12">
        ...
        <p class="text-gray-500 text-lg max-w-2xl mx-auto">
          Join thousands of professionals at these upcoming and live virtual
          exhibitions
        </p>
      </div>
      ...
      <!-- Empty -->
      <div
        v-else-if="trendingExpos.length === 0"
      ...
      <div v-else class="grid grid-cols-3 gap-6">
        ...
        >
          <div class="p-6 flex flex-col flex-1">
            <div class="flex items-center gap-2 mb-4">
              ...
              >
                <span
                  ...
                  :class="statusDot[getStatus(expo)]"
                />
                {{ getStatus(expo) }}
              </span>
              <span
            ...
            <h3
              class="font-bold text-gray-900 text-lg mb-2 group-hover:text-[#3d52d5] transition-colors line-clamp-1"
            >
              {{ expo.name }}
            </h3>
            <p
              class="text-sm text-gray-500 mb-5 line-clamp-2 leading-relaxed flex-1"
            >
              ...
              <div class="flex items-center gap-1.5 text-xs text-gray-500">
                ...
                <span
                  ><strong class="text-gray-800">{{
                    expo.booths?.length ?? 0
                  }}</strong>
                  booths</span
                >
              </div>
              <div
                class="ml-auto flex items-center gap-1 text-xs font-semibold text-[#3d52d5] group-hover:gap-2 transition-all"
              >
                Explore
    ...
    <div v-if="auth.isLoggedIn.value === false">
      ...
      <section class="mb-40">
        <div class="flex flex-col items-center text-center mb-12">
          ...
          <p class="text-gray-500 text-lg max-w-2xl mx-auto">
            Powerful features designed to make virtual exhibitions engaging and
            productive.
          </p>
        </div>
        <div class="grid grid-cols-4 gap-6 pl-30 pr-30 mb-20">
          <UCard
            class="p-8 text-center border rounded-2xl border-blue-200 bg-white/80 backdrop-blur-sm hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-300 hover:-translate-y-1"
          >
            <div
              class="w-16 h-16 mx-auto mb-4 rounded-2xl bg-linear-to-br from-blue-500 to-blue-600 flex items-center justify-center shadow-lg"
            >
              <UIcon name="i-lucide-map-pin" class="w-8 h-8 text-white" />
            </div>
            <h1 class="text-lg font-bold mb-2">Interactive 2D Maps</h1>
            <p class="text-sm text-gray-500">
              Navigate expo halls with ease using our intuitive floor plans
            </p>
          </UCard>
          <UCard
            class="p-8 text-center border rounded-2xl border-blue-200 bg-white/80 backdrop-blur-sm hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-300 hover:-translate-y-1"
          ...
          >
            ...
            <p class="text-sm text-gray-500">
              Connect with exhibitors and organizers throughout the expo
            </p>
          </UCard>
          <UCard
            class="p-8 text-center border rounded-2xl border-blue-200 bg-white/80 backdrop-blur-sm hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-300 hover:-translate-y-1"
          >
            ...
            <p class="text-sm text-gray-500">
              Book meetings and never miss upcoming events
            </p>
          </UCard>
        </div>
      </section>
      ...
      <section class="max-w-4xl mx-auto pb-24">
        <UCard
          class="flex justify-center text-center border-blue-200 bg-linear-to-br from-blue-600 to-blue-500 text-white shadow-2xl shadow-blue-500/40 rounded-2xl h-70"
        >
          <div class="mb-8">
            ...
            <p class="text-lg text-blue-200 mt-6 pl-30 pr-30">
              Join leading organizations using ExpoVerse to host world-class
              virtual exhibitions
            </p>
          </div>
          <div class="flex gap-5 justify-center">
            <UButton
              ...
              size="lg"
              >Get Started Now</UButton
            >
            <UButton
              block
              class="bg-white hover:bg-blue-100 shadow-lg shadow-blue-500/30 text-blue-500 cursor-pointer h-10 w-40 rounded-xl"
              size="lg"
              >Schedule Demo</UButton
            >
          </div>
        </UCard>
      </section>
